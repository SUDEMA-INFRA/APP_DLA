...
class VistoriaAgroindustrial(models.Model):
    ...
    produz_efluentes = models.BooleanField(null=True, blank=True)
    efluentes_coleta_destinacao = models.TextField(null=True, blank=True)
    produz_residuos = models.BooleanField(null=True, blank=True)
    residuos_coleta_destinacao = models.TextField(null=True, blank=True)
    gera_utiliza_bagaco = models.BooleanField(null=True, blank=True)
    bagaco_armazenamento_destinacao = models.TextField(null=True, blank=True)
    fontes_termicas = models.BooleanField(null=True, blank=True)
    fontes_termicas_quais = models.TextField(null=True, blank=True)
    utiliza_lenha = models.BooleanField(null=True, blank=True)
    lenha_nativa_exotica = models.TextField(null=True, blank=True)
    lenha_local_armazenamento = models.TextField(null=True, blank=True)
    tanques_adequados = models.BooleanField(null=True, blank=True)
    higienizacao_controle_efluentes = models.BooleanField(null=True, blank=True)
    fossa_septica = models.BooleanField(null=True, blank=True)
    equipamentos_memorial = models.BooleanField(null=True, blank=True)
    chamines_controle_emissoes = models.BooleanField(null=True, blank=True)
    sistema_vinhaca = models.BooleanField(null=True, blank=True)
    vinhaca_condicoes = models.TextField(null=True, blank=True)
    tanques_lagoas_impermeabilizadas = models.BooleanField(null=True, blank=True)
    vazamentos_infiltracoes = models.BooleanField(null=True, blank=True)
    efluentes_destinados_corretamente = models.BooleanField(null=True, blank=True)
    gestao_residuos_pgrs = models.BooleanField(null=True, blank=True)
    area_especifica_envase = models.BooleanField(null=True, blank=True)
    envase_condicoes = models.TextField(null=True, blank=True)
    armazenamento_requisitos_ambientais = models.BooleanField(null=True, blank=True)
    faz_uso_agrotoxicos = models.BooleanField(null=True, blank=True)
    agrotoxicos_quais = models.TextField(null=True, blank=True)
    agrotoxicos_receituario = models.TextField(null=True, blank=True)
    agrotoxicos_embalagens_destinacao = models.TextField(null=True, blank=True)
    foto_geo_ok = models.BooleanField(null=True, blank=True)
    infracao_constatada = models.BooleanField(null=True, blank=True)
    infracao_sugestao_medidas = models.TextField(null=True, blank=True)
    observacoes_complementares = models.TextField(null=True, blank=True)
...
class VistoriaAgricultura(models.Model):
    ...
    # 6 technical items for Atividades Agrícolas
    atividade_agricola = models.TextField(null=True, blank=True)
    atividade_irrigada = models.BooleanField(null=True, blank=True)
    irrigada_outorga = models.TextField(null=True, blank=True)
    faz_uso_agrotoxicos = models.BooleanField(null=True, blank=True)
    agrotoxicos_quais = models.TextField(null=True, blank=True)
    agrotoxicos_receituario = models.TextField(null=True, blank=True)
    agrotoxicos_embalagens_destinacao = models.TextField(null=True, blank=True)
    tem_cursos_hidricos = models.BooleanField(null=True, blank=True)
    foto_geo_ok = models.BooleanField(null=True, blank=True)
    infracao_constatada = models.BooleanField(null=True, blank=True)
    infracao_sugestao_medidas = models.TextField(null=True, blank=True)
    observacoes_complementares = models.TextField(null=True, blank=True)
